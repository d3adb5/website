...
subtitle: How did you find your way here?
...
Much like myself, this website is constantly evolving --- and doing so slowly.
You can navigate it through the section links at the top, but there are also
[some extra pages][extra] that don't fit anywhere else on the site. The latest
updates will be listed below as Git commits, and there will be a link to the
latest relevant commit for each page on the page footer.
...
If you wish to communicate with me, send a message to `me` at this domain. If
you use PGP, here are my keys:
