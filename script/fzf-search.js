(() => {
  ...
  // ns-params:@params
  var params_default = { identifierSelector: "td.title", inputSelector: "input#search-box", resultsSelector: "table#blog-index tbody" };

  // <stdin>
  var resultsElem = document.querySelector(params_default.resultsSelector);
  var inputBox = document.querySelector(params_default.inputSelector);
  ...
  function extractIdentifier(element) {
    return element.querySelector(params_default.identifierSelector).textContent;
  }
